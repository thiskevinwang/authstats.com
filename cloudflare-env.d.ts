/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 87396eb5e71c16b55d1bb95fcdc7f094)
// Runtime types generated with workerd@1.20260521.1 2026-05-25 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	VIEWABLE_REGISTRIES: "npm";
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Service<typeof import("./src/worker").default>;
	DOWNLOAD_STATS_WORKFLOW: Workflow<Parameters<import("./src/worker").DownloadStatsWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VIEWABLE_REGISTRIES" | "NEXTJS_ENV">> {}
}
